...
exports.SetOperationMenu = void 0;
...
const sort_1 = require("../../components/ContextMenu/sort");
exports.SetOperationMenu = react_1.default.forwardRef((_a, ref) => {
    var { hideMenu, onSelectType, operationType } = _a, props = __rest(_a, ["hideMenu", "onSelectType", "operationType"]);
    const { allNodes } = (0, trees_1.useTreesState)();
    const [menuSearchValue, setMenuSearchValue] = (0, react_1.useState)("");
    const [selectedIndex, setSelectedIndex] = (0, react_1.useState)(0);
    const creationNodes = (0, react_1.useMemo)(() => (0, Resolve_1.ResolvePossibleOperationTypes)(allNodes.nodes), [allNodes]);
    ...
    return (react_1.default.createElement(components_1.Menu, Object.assign({}, props, { ref: ref, menuName: `Set ${operationType}`, onScroll: (e) => e.stopPropagation(), hideMenu: hideMenu }),
...
exports.SetOperationMenu.displayName = "SetOperationMenu";
